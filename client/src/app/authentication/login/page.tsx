...
export default function Login({ setLoginOpen ,loginOpen}: LoginProps) {
    ...
    return (
        <Dialog open={loginOpen} onOpenChange={setLoginOpen}>
            ...
            >   <div className='w-full flex items-center justify-end '>
                ...
                <p className='md:w-[85%] w-[100%] text-sm text-center'>By continuing, you agree to our <Link href={"/Agreement"} className='hover:underline text-blue-600'>User Agreement</Link> and acknowledge that you understand the  <Link href={"/Agreement"} className='hover:underline text-blue-600'>Privacy Policy</Link>.</p>
                ...
                <div className='md:w-[85%] w-[100%] flex flex-col space-y-2'>
                    <Link 
                    onClick={handleBackgroundClick}
                    href={"/forgot-password"} className='hover:underline text-blue-500 text-sm'>Forgot Password?</Link>
                    <Link 
                    onClick={handleBackgroundClick}
                    href={"/authentication/register"} className='hover:underline text-blue-500 text-sm'>Sign up</Link>
                </div>
